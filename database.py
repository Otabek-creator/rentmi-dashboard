"""
database.py — PostgreSQL ulanish va jadval yaratish (Optimized)

✅ Connection Pooling — SimpleConnectionPool orqali
✅ Query Caching — @st.cache_data(ttl=300) bilan 5 daqiqa keshlanadi
"""
...
def _get_pool():
    ...
    try:
        ...
        st.error(f"❌ Database pool yaratilmadi: {e}")
        return None
...
def clear_cache():
    """Keshni tozalash (yangilash tugmasi uchun)"""
    execute_query.clear()
